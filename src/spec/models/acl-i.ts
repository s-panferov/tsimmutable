...
/**
* Map interface for Acl with specialized getters and setters.
*/

export interface AclMap extends ImmutableMethods<string, any, AclMap> {

    $AclMap: AclMap

    get(key: 'isAdmin', defaultValue?: boolean): boolean
    set(key: 'isAdmin', value: boolean): AclMap

    get(key: 'canEditArticles', defaultValue?: boolean): boolean
    set(key: 'canEditArticles', value: boolean): AclMap


    get(key: string, defaultValue?: any): any;
    set(key: string, value: typeof undefined): AclMap;
...
export interface AclRecordShape extends ImmutableMethods<string, any, AclRecordShape> {

    $AclRecordShape: AclRecordShape

    isAdmin: boolean
    get(key: 'isAdmin', defaultValue?: boolean): boolean
    set(key: 'isAdmin', value: boolean): AclRecordShape

    canEditArticles: boolean
    get(key: 'canEditArticles', defaultValue?: boolean): boolean
    set(key: 'canEditArticles', value: boolean): AclRecordShape


    get(key: string, defaultValue?: any): any;
    set(key: string, value: typeof undefined): AclRecordShape;
...
/**
 * Default fields that must be provided in AclRecord.
 */
export interface AclRecordDefaults {
    isAdmin: boolean
    canEditArticles: boolean
}

/**
 * Typed AclRecord constructor.
 */
export let AclRecordCtor: RecordCtor<AclRecordDefaults, AclRecordShape> = Immutable.Record as any;

/**
 * Special method to parse AclRecord with all the dependencies.
 */
export function parseAclRecord(value: Acl, deps: any): AclRecordShape {
    ...
    return new deps.AclRecord(result);
}

export class AclRecord extends AclRecordCtor({
    isAdmin: null,
    canEditArticles: null,
}) {
    static fromJS(value: Acl, deps: any): AclRecord {
        return parseAclRecord(value, deps)
    }
}
